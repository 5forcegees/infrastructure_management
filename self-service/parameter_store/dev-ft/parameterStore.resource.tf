...
#  name        = "/CI/MS/dev-ft/MCF/Landlord/User"
#  type        = "String"
#  value       = "UMC_LRD_SRV"
#  description = ""
...
resource "aws_ssm_parameter" "AWSLogTarget-LogGroup" {
  name        = "/CI/MS/dev-ft/AWSLogTarget/LogGroup"
  type        = "String"
  value       = "dev-ft-account-history"
  description = ""
  tags = "${var.default_tags}"
}

resource "aws_ssm_parameter" "AWSLogTarget-Region" {
  name        = "/CI/MS/dev-ft/AWSLogTarget/Region"
  type        = "String"
  value       = "us-west-2"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "BillMatrix-CliendID" {
  name        = "/CI/MS/dev-ft/BillMatrix/CliendID"
  type        = "String"
  value       = "1629"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "BillMatrix-PaymentChannel_Fee" {
  name        = "/CI/MS/dev-ft/BillMatrix/PaymentChannel_Fee"
  type        = "String"
  value       = "I|L001629"
...
resource "aws_ssm_parameter" "BillMatrix-PaymentChannel_NoFee" {
  name        = "/CI/MS/dev-ft/BillMatrix/PaymentChannel_NoFee"
  type        = "String"
  value       = "I|K001629"
...
resource "aws_ssm_parameter" "BillMatrix-PaymentChannel_Registered_Fee" {
  name        = "/CI/MS/dev-ft/BillMatrix/PaymentChannel_Registered_Fee"
  type        = "String"
  value       = "I|J001629"
...
resource "aws_ssm_parameter" "BillMatrix-PaymentChannel_Registered_NoFee" {
  name        = "/CI/MS/dev-ft/BillMatrix/PaymentChannel_Registered_NoFee"
  type        = "String"
  value       = "I|I001629"
...
resource "aws_ssm_parameter" "BillMatrix-Url" {
  name        = "/CI/MS/dev-ft/BillMatrix/Url"
  type        = "String"
...
resource "aws_ssm_parameter" "BudgetBilling-MonthsBackValue" {
  name        = "/CI/MS/dev-ft/BILLINGHISTORY/MONTHSBACK"
  type        = "String"
  value       = "24"
...
resource "aws_ssm_parameter" "BucketName-Correspondence" {
  name        = "/CI/MS/dev-ft/Document/BucketName/Correspondence"
  type        = "String"
  value       = "clientdev-ftcorrespondence"
  description = "S3 bucket for correspondence documents"
  tags = "${var.default_tags}"
}

resource "aws_ssm_parameter" "BucketName-Statements" {
  name        = "/CI/MS/dev-ft/Document/BucketName/Statements"
  type        = "String"
...
resource "aws_ssm_parameter" "CassandraSettings-ConsistencyLevel" {
  name        = "/CI/MS/dev-ft/CassandraSettings/ConsistencyLevel"
  type        = "String"
  value       = "LocalQuorum"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "CassandraSettings-Hosts" {
  name        = "/CI/MS/dev-ft/CassandraSettings/Hosts"
  type        = "String"
...
resource "aws_ssm_parameter" "CassandraSettings-MaxConnectionsFromHost" {
  name        = "/CI/MS/dev-ft/CassandraSettings/MaxConnectionsFromHost"
  type        = "String"
  value       = "100"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "CassandraSettings-Port" {
  name        = "/CI/MS/dev-ft/CassandraSettings/Port"
  type        = "String"
  value       = "9042"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "CassandraSettings-UseClusterCredentials" {
  name        = "/CI/MS/dev-ft/CassandraSettings/UseClusterCredentials"
  type        = "String"
  value       = "true"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "CassandraSettings-UseQueryOptions" {
  name        = "/CI/MS/dev-ft/CassandraSettings/UseQueryOptions"
  type        = "String"
  value       = "true"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "CassandraSettings-UseSSL" {
  name        = "/CI/MS/dev-ft/CassandraSettings/UseSSL"
  type        = "String"
  value       = "false"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Shared-CassandraKeyspace-Microservices" {
  name        = "/CI/MS/dev-ft/Cassandra/Keyspace/Microservices"
  type        = "String"
  value       = "microservices"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Shared-CassandraKeyspace-SelfServiceAuth" {
  name        = "/CI/MS/dev-ft/Cassandra/Keyspace/SelfServiceAuth"
  type        = "String"
...
resource "aws_ssm_parameter" "RegionEndpoint" {
  name        = "/CI/MS/dev-ft/RegionEndpoint"
  type        = "String"
  value       = "us-west-2"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Cognito-UserPool" {
  name        = "/CI/MS/dev-ft/Cognito/UserPool"
  type        = "String"
...
resource "aws_ssm_parameter" "ContractAccountValidator-CacheExpiration" {
  name        = "/CI/MS/dev-ft/ContractAccountValidator/CacheExpiration"
  type        = "String"
  value       = "00:10:00"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Dev-ALB_URL" {
  name        = "/CI/MS/dev-ft/ALB_URL"
  type        = "String"
  value       = "http://selfservice-dev-feature-alb.client.com"
  description = ""
  tags = "${var.default_tags}"
}

resource "aws_ssm_parameter" "DQM-EndPointAddress" {
  name        = "/CI/MS/dev-ft/DQM/EndPointAddress"
  type        = "String"
...
resource "aws_ssm_parameter" "EgainPropertyManagerService-FromEmail" {
  name        = "/CI/MS/dev-ft/Forms/EgainPropertyManagerService/FromEmail"
  type        = "String"
...
resource "aws_ssm_parameter" "EgainPropertyManagerService-Subject" {
  name        = "/CI/MS/dev-ft/Forms/EgainPropertyManagerService/Subject"
  type        = "String"
...
resource "aws_ssm_parameter" "EgainPropertyManagerService-ToEmail" {
  name        = "/CI/MS/dev-ft/Forms/EgainPropertyManagerService/ToEmail"
  type        = "String"
...
resource "aws_ssm_parameter" "Forms-EmailServiceEndPoint" {
  name        = "/CI/MS/dev-ft/Forms/EmailServiceEndPoint"
  type        = "String"
...
resource "aws_ssm_parameter" "Renewable-ServiceUrl" {
  name        = "/CI/MS/dev-ft/Forms/Renewable/ServiceUrl"
  type        = "String"
...
resource "aws_ssm_parameter" "LEGACY_client-NotOutPort" {
  name        = "/CI/MS/dev-ft/LEGACY_client/NotOutPort"
  type        = "String"
  value       = "8081"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "LEGACY_client-URL" {
  name        = "/CI/MS/dev-ft/LEGACY_client/URL"
  type        = "String"
...
resource "aws_ssm_parameter" "client-Not-Out" {
  name        = "/CI/MS/dev-ft/client/Not-Out/URL"
  type        = "String"
...
resource "aws_ssm_parameter" "MCF-SSL_PORT" {
  name        = "/CI/MS/dev-ft/MCF/SSL_PORT"
  type        = "String"
  value       = "8005"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Notification-EmailServiceEndPoint" {
  name        = "/CI/MS/dev-ft/Notification/EmailServiceEndPoint"
  type        = "String"
  value       = "http://10.41.12.25/NonHttclientmail/Service1.svc"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "authentication-mcf-gateway" {
  name        = "/CI/MS/dev-ft/Authentication/Mcf/Gateway"
  type        = "String"
...
resource "aws_ssm_parameter" "PasswordReset-MaxAttemptsPerChallenge" {
  name        = "/CI/MS/dev-ft/Authentication/PasswordReset/MaxAttemptsPerChallenge"
  type        = "String"
  value       = "3"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "PasswordReset-MaxChallenges" {
  name        = "/CI/MS/dev-ft/Authentication/PasswordReset/MaxChallenges"
  type        = "String"
  value       = "2"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "SecurityQuestions-PasswordResetTimespanMinutes" {
  name        = "/CI/MS/dev-ft/Authentication/PasswordReset/TokenLifespanMinutes"
  type        = "String"
  value       = "15"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "SecurityQuestions-PasswordResetLockMinutes" {
  name        = "/CI/MS/dev-ft/Authentication/PasswordReset/LockMinutes"
  type        = "String"
  value       = "1440"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "SecurityQuestions-MaximumSet" {
  name        = "/CI/MS/dev-ft/Authentication/SecurityQuestions/MaximumSet"
  type        = "String"
  value       = "4"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "SecurityQuestions-MinimumSet" {
  name        = "/CI/MS/dev-ft/Authentication/SecurityQuestions/MinimumSet"
  type        = "String"
  value       = "2"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Authentication-LockUser-IncorrectPasswordRetentionMinutes" {
  name        = "/CI/MS/dev-ft/Authentication/LockUser/IncorrectPasswordRetentionMinutes"
  type        = "String"
  value       = "15"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Authentication-LockUser-IncorrectPasswordLockMinutes" {
  name        = "/CI/MS/dev-ft/Authentication/LockUser/IncorrectPasswordLockMinutes"
  type        = "String"
  value       = "15"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Authentication-LockUser-IncorrectPasswordMaxAttempts" {
  name        = "/CI/MS/dev-ft/Authentication/LockUser/IncorrectPasswordMaxAttempts"
  type        = "String"
  value       = "5"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Authentication-Cognito-ClientId" {
  name        = "/CI/MS/dev-ft/Authentication/Cognito/ClientId"
  type        = "String"
...
resource "aws_ssm_parameter" "Authentication-Cognito-ImpersonationClientId" {
  name        = "/CI/MS/dev-ft/Authentication/Cognito/ImpersonationClientId"
  type        = "String"
...
resource "aws_ssm_parameter" "Authentication-Cognito-AdminClientId" {
  name        = "/CI/MS/dev-ft/Authentication/Cognito/AdminClientId"
  type        = "String"
  value       = "${data.terraform_remote_state.infrastructure.cognito_user_pool_client_impersonation_id}"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Authentication-ResetPassword-SiteCorePasswordResetUrlBase" {
  name        = "/CI/MS/dev-ft/Authentication/PasswordReset/SiteCorePasswordResetUrlBase"
  type        = "String"
...
resource "aws_ssm_parameter" "Authentication-OutageSession-SessionExpirationInMinutes" {
  name        = "/CI/MS/dev-ft/Authentication/OutageSession/SessionExpirationInMinutes"
  type        = "String"
  value       = "180"
...
resource "aws_ssm_parameter" "Outage-Queue-ExceptionInbox" {
  name        = "/CI/MS/dev-ft/Outage/Queue/ExceptionInbox"
  type        = "String"
...
resource "aws_ssm_parameter" "Outage-Queue-Default-RateLimit" {
  name        = "/CI/MS/dev-ft/Outage/Queue/Default/RateLimit"
  type        = "String"
  value       = "10"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Outage-Queue-ReportOutage-Namespace" {
  name        = "/CI/MS/dev-ft/Outage/Queue/Mcf/ReportOutage"
  type        = "String"
...
resource "aws_ssm_parameter" "Spa-ServiceUrl" {
  name        = "/CI/MS/dev-ft/Project/Spa/ServiceUrl"
  type        = "String"
...
resource "aws_ssm_parameter" "StreetLight-EndPointAddress" {
  name        = "/CI/MS/dev-ft/Forms/StreetLight/EndPointAddress"
  type        = "String"
  value       = "http://10.41.12.25/NonHttclientmail/Service1.svc"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "StreetLight-FromEmail" {
  name        = "/CI/MS/dev-ft/Forms/StreetLight/FromEmail"
  type        = "String"
  value       = "test@client.com"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "StreetLight-Subject" {
  name        = "/CI/MS/dev-ft/Forms/StreetLight/Subject"
  type        = "String"
...
resource "aws_ssm_parameter" "StreetLight-ToEmail" {
  name        = "/CI/MS/dev-ft/Forms/StreetLight/ToEmail"
  type        = "String"
...
resource "aws_ssm_parameter" "LEGACY_client-AnonymousCallsEndpoint" {
  name        = "/CI/MS/dev-ft/LEGACY_client/AnonymousCallsEndpoint"
  type        = "String"
...
resource "aws_ssm_parameter" "Authentication-LockUser-DefaultLockHours" {
  name        = "/CI/MS/dev-ft/Authentication/LockUser/DefaultLockHours"
  type        = "String"
  value       = "1"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Document-MonthlyInsertURL" {
  name        = "/CI/MS/dev-ft/Document/MonthlyInsertURL"
  type        = "String"
...
resource "aws_ssm_parameter" "Document-DocumentHistoryBaseURL" {
  name        = "/CI/MS/dev-ft/Document/DocumentHistoryBaseURL"
  type        = "String"
...
resource "aws_ssm_parameter" "Notification-PreferenceUpdate-SNSTopicARN" {
  name        = "/CI/MS/dev-ft/Notification/PreferenceUpdate/SNSTopicARN"
  type        = "String"
...
resource "aws_ssm_parameter" "Notification-SendNotification-SNSTopicARN" {
  name        = "/CI/MS/dev-ft/Notification/SendNotification/SNSTopicARN"
  type        = "String"
...
resource "aws_ssm_parameter" "CommGateway-ServiceRelay-SNSTopicARN" {
  name        = "/CI/MS/dev-ft/CommGateway/ServiceRelay-SNSTopicARN"
  type        = "String"
...
resource "aws_ssm_parameter" "MB-ApiEndpoint" {
  name        = "/CI/MS/dev-ft/MB/ApiEndpoint"
  type        = "String"
...
resource "aws_ssm_parameter" "Commgateway-PrefUp-SAP-AWSSQSQueueUrl" {
  name        = "/CI/MS/dev-ft/CommGateway/prefUp-sap-SQS"
  type        = "String"
...
resource "aws_ssm_parameter" "Commgateway-PrefUp-MB-AWSSQSQueueUrl" {
  name        = "/CI/MS/dev-ft/CommGateway/prefUp-mb-SQS"
  type        = "String"
...
resource "aws_ssm_parameter" "Commgateway-Service-Relay-AWSSQSQueueUrl" {
  name        = "/CI/MS/dev-ft/CommGateway/service-relay-SQS"
  type        = "String"
...
resource "aws_ssm_parameter" "Commgateway-Message-Intercept-AWSSQSQueueUrl" {
  name        = "/CI/MS/dev-ft/CommGateway/message-intercept-SQS"
  type        = "String"
...
resource "aws_ssm_parameter" "Account-AWSSQSQueueUrl" {
  name        = "/CI/MS/dev-ft/Account/AWSQueueReader/AWSSQSQueueUrl"
  type        = "String"
...
resource "aws_ssm_parameter" "Customer-AWSSQSQueueUrl" {
  name        = "/CI/MS/dev-ft/Customer/AWSQueueReader/AWSSQSQueueUrl"
  type        = "String"
...
resource "aws_ssm_parameter" "Device-AWSSQSQueueUrl" {
  name        = "/CI/MS/dev-ft/Device/AWSQueueReader/AWSSQSQueueUrl"
  type        = "String"
...
resource "aws_ssm_parameter" "Payment-AWSSQSQueueUrl" {
  name        = "/CI/MS/dev-ft/Payment/AWSQueueReader/AWSSQSQueueUrl"
  type        = "String"
...
resource "aws_ssm_parameter" "Statement-AWSSQSQueueUrl" {
  name        = "/CI/MS/dev-ft/Statement/AWSQueueReader/AWSSQSQueueUrl"
  type        = "String"
...
resource "aws_ssm_parameter" "BudgetBill-AWSSQSQueueUrl" {
  name        = "/CI/MS/dev-ft/BudgetBill/AWSQueueReader/AWSSQSQueueUrl"
  type        = "String"
...
resource "aws_ssm_parameter" "Authentication-ResetPassword-BusinessCategory" {
  name        = "/CI/MS/dev-ft/Authentication/PasswordReset/BusinessCategory"
  type        = "String"
...
resource "aws_ssm_parameter" "Authentication-ResetPassword-BusinessSubCategory" {
  name        = "/CI/MS/dev-ft/Authentication/PasswordReset/BusinessSubCategory"
  type        = "String"
  value       = "MA-07-001"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Authentication-UserActivity-BusinessCategory" {
  name        = "/CI/MS/dev-ft/Authentication/UserActivity/BusinessCategory"
  type        = "String"
  value       = "Account_Services"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Authentication-UserActivity-BusinessSubCategory" {
  name        = "/CI/MS/dev-ft/Authentication/UserActivity/BusinessSubCategory"
  type        = "String"
  value       = "MA-07-001"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Authentication-LEGACY_client-SamlTokenUrl" {
  name        = "/CI/MS/dev-ft/Authentication/LEGACY_client/SamlTokenUrl"
  type        = "String"
...
resource "aws_ssm_parameter" "Authentication-Logging-MinimumLevel" {
  name        = "/CI/MS/dev-ft/Authentication/Logging/MinimumLevel"
  type        = "String"
  value       = "Debug"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Document-Logging-MinimumLevel" {
  name        = " /CI/MS/dev-ft/document/Logging/MinimumLevel"
  type        = "String"
  value       = "Debug"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Outage-Logging-MinimumLevel" {
  name        = " /CI/MS/dev-ft/outage/Logging/MinimumLevel"
  type        = "String"
  value       = "Debug"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Shared-Logging-MinimumLevel" {
  name        = "/CI/MS/dev-ft/Shared/Logging/MinimumLevel"
  type        = "String"
  value       = "Information"
  description = ""
  tags = "${var.default_tags}"
...
resource "aws_ssm_parameter" "Outage-Host" {
  name        = "/CI/MS/dev-ft/OutageServicesApi/Host"
  type        = "String"
  value       = "http://${data.terraform_remote_state.infrastructure.third_party_alb_dns}"
